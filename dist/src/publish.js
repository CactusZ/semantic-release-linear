...
function publish(pluginConfig, context) {
    return __awaiter(this, void 0, void 0, function () {
        var branchName, branchConfig, linearClient, cards;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    branchName = context.envCi.branch;
                    branchConfig = pluginConfig.mutateIssues.find(function (c) { return c.branchName === branchName; });
                    if (!branchConfig) {
                        return [2 /*return*/];
                    }
                ...
                case 1:
                    cards = _a.sent();
                    return [4 /*yield*/, (0, api_1.moveCards)({
                            cards: cards,
