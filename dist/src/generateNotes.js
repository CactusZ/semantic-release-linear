...
function generateNotes(pluginConfig, context) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var linearClient, branch, stateName, cards, releaseNotes, sortedCards, _i, sortedCards_1, card;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    stateName = (_a = pluginConfig.generateNotes.find(function (b) { return b.branchName === branch; })) === null || _a === void 0 ? void 0 : _a.stateName;
                    if (!stateName) {
                ...
                case 1:
                    ...
                    if (cards.length) {
                        ...
                        sortedCards = lodash_1.default.sortBy(cards, "identifier");
                        for (_i = 0, sortedCards_1 = sortedCards; _i < sortedCards_1.length; _i++) {
                            card = sortedCards_1[_i];
